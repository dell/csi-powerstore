...
func getValidPublishContext() map[string]string {
	return map[string]string{
		...
		powerstorecommon.PublishContextISCSIPortalsPrefix + "0":   validISCSIPortals[0],
		powerstorecommon.PublishContextISCSIPortalsPrefix + "1":   validISCSIPortals[1],
		powerstorecommon.PublishContextISCSITargetsPrefix + "0":   validISCSITargets[0],
		powerstorecommon.PublishContextISCSITargetsPrefix + "1":   validISCSITargets[1],
		powerstorecommon.PublishContextNVMEFCPortalsPrefix + "0":  validNVMEFCPortals[0],
		powerstorecommon.PublishContextNVMEFCPortalsPrefix + "1":  validNVMEFCPortals[1],
		powerstorecommon.PublishContextNVMEFCTargetsPrefix + "0":  validNVMEFCTargets[0],
		powerstorecommon.PublishContextNVMEFCTargetsPrefix + "1":  validNVMEFCTargets[1],
		powerstorecommon.PublishContextNVMETCPPortalsPrefix + "0": validNVMETCPPortals[0],
		powerstorecommon.PublishContextNVMETCPPortalsPrefix + "1": validNVMETCPPortals[1],
		powerstorecommon.PublishContextNVMETCPTargetsPrefix + "0": validNVMETCPTargets[0],
		powerstorecommon.PublishContextNVMETCPTargetsPrefix + "1": validNVMETCPTargets[1],
		powerstorecommon.PublishContextFCWWPNPrefix + "0":         validFCTargetsWWPN[0],
		powerstorecommon.PublishContextFCWWPNPrefix + "1":         validFCTargetsWWPN[1],
	}
}

func getValidRemoteMetroPublishContext() map[string]string {
	publishContext := getValidPublishContext()
	publishContext[powerstorecommon.PublishContextRemoteLUNAddress] = validLUNID
	publishContext[powerstorecommon.PublishContextRemoteDeviceWWN] = validDeviceWWN
	publishContext[powerstorecommon.PublishContextRemoteISCSIPortalsPrefix+"0"] = validRemoteISCSIPortals[0]
	publishContext[powerstorecommon.PublishContextRemoteISCSIPortalsPrefix+"1"] = validRemoteISCSIPortals[1]
	publishContext[powerstorecommon.PublishContextRemoteISCSITargetsPrefix+"0"] = validRemoteISCSITargets[0]
	publishContext[powerstorecommon.PublishContextRemoteISCSITargetsPrefix+"1"] = validRemoteISCSITargets[1]
	publishContext[powerstorecommon.PublishContextRemoteFCWWPNPrefix+"0"] = validRemoteFCTargetsWWPN[0]
	publishContext[powerstorecommon.PublishContextRemoteFCWWPNPrefix+"1"] = validRemoteFCTargetsWWPN[1]
