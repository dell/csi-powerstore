...
func (_m *FsInterface) GetUtil() fs.UtilInterface {
	ret := _m.Called()

	var r0 fs.UtilInterface
	if rf, ok := ret.Get(0).(func() fs.UtilInterface); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(fs.UtilInterface)
		}
	}
...
func (_m *FsInterface) Mkdir(name string, perm os.FileMode) error {
...
func (_m *FsInterface) MkdirAll(name string, perm os.FileMode) error {
	ret := _m.Called(name, perm)
...
func (_m *FsInterface) OpenFile(name string, flag int, perm os.FileMode) (*os.File, error) {
...
func (_m *FsInterface) Stat(name string) (fs.FileInfo, error) {
	ret := _m.Called(name)
...
func (_m *FsInterface) WriteFile(filename string, data []byte, perm os.FileMode) error {
