...
func (_m *NVMEConnector) ConnectVolume(ctx context.Context, info gobrick.NVMeVolumeInfo) (gobrick.Device, error) {
	ret := _m.Called(ctx, info)

	var r0 gobrick.Device
	if rf, ok := ret.Get(0).(func(context.Context, gobrick.NVMeVolumeInfo) gobrick.Device); ok {
		r0 = rf(ctx, info)
	} else {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, gobrick.NVMeVolumeInfo) error); ok {
		r1 = rf(ctx, info)
	} else {
		r1 = ret.Error(1)
	}
